	...
	<div class="container">
		...
		<table id="ingredientTable">
			...
			<tbody>
				<c:forEach items="${ingredientList}" var="ingredient">
					<tr>
						...
						<td><a href="${urlPrefix}/remove?productId=${ingredient.product.id}"> <img
			...
			<tfoot>
				<tr>
					<td colspan="3">
						<form action="${urlPrefix}/add" method="get" class="form-inline">
		...
		<button onclick="window.location='${urlPrefix}/validate'">Valider</button>
	</div>
